...
const CreateEmployee = () => {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      error? setError(error?.data?.message): alert("Something went wrong");
      setTimeout(() => {
        navigate(-1) 
      }, 3000)
    }
      ...
      <div id="mainsection">
        ...
        >
          ...
          <div id="last">
            ...
            <Button
              buttonID="createEmployee"
              name="Cancel"
              type="reset"
              onChange={handleCancel}
            />
          </div>
          {error?<p id="formError">{error}</p> : null} 
        </form>
      </div>
    </>
  );
